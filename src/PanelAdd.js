...
class PanelAdd extends React.Component{
    ...
    createItem(e){
        ...
        this.props.onadd({title: title, image: image, calificacion: calificacion});
        this.cancelAction();
    }
            ...
            <div className="new-item-panel-container">
                <div className="new-item-panel">
                    <form onSubmit={this.createItem}>
                        ...
                        <p>
                        <label>direccion de imagen para adjuntar</label><br />
                        ...
                        <input type="submit" className="button btn-blue" value="Aceptar" />
